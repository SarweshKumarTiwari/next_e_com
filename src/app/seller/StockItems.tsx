                ...
                <div className="w-full bg-white px-4 py-4">
                    ...
                    <div className="p-2 x-2 flex border border-gray-200 space-x-4 overflow-y-auto">
                        ...
                        <div className="flex w-full justify-between p-1 ">
                            <div className="flex flex-col justify-between ml-4 flex-grow w-[33.33%] ">
                            ...
                            <span className=" w-[33.33%] text-center font-semibold text-sm">50</span>
                            <span className=" w-[33.33%] text-center font-semibold text-sm">444</span>
                        </div>
                    </div>
                </div>
            </div>
